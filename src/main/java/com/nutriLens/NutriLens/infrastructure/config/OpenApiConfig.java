    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .servers(List.of(
                        ...
                        new Server().url("https://api.nutrilens.com").description("Servidor de producción")))
                ...
                .components(new Components()
                        .addSecuritySchemes(securitySchemeName,
                                new SecurityScheme()
                                        ...
                                        .scheme("bearer")
                                        .bearerFormat("JWT")
                                        .description("Token JWT de autenticación. Obtener mediante /auth/login o /auth/register")));
    }
}
